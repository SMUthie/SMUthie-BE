module.exports = {
  ...
  SIGNUP_STUDENT_ID_EMPTY: {
    isSuccess: false,
    code: 2001,
    message: '학번을 입력해주세요',
  },
  SIGNUP_STUDENT_ID_LENGTH: {
    isSuccess: false,
    code: 2002,
    message: '학번은 15자리 미만으로 입력해주세요.',
  },
  SIGNUP_STUDENT_ID_ERROR_TYPE: {
    isSuccess: false,
    code: 2003,
    message: '학번 형식을 정확하게 입력해주세요.',
  },
  ...
  SIGNIN_STUDENT_ID_WRONG: {
    isSuccess: false,
    code: 3003,
    message: '학번이 잘못 되었습니다.',
  },
